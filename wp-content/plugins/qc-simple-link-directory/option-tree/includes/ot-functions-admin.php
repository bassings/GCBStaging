					...
					array(
						...
						'pages' => array(
							array(
								...
								'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Theme Options', 'qc-opd' ) ),
								'menu_title'      => apply_filters( 'ot_theme_options_menu_title', esc_html__( 'Theme Options', 'qc-opd' ) ),
								'capability'      => $caps,
								...
								'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Theme Options updated.', 'qc-opd' ) ),
								'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Theme Options reset.', 'qc-opd' ) ),
								'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Save Changes', 'qc-opd' ) ),
	...
	function ot_register_settings_page() {
		...
		if ( true === OT_SHOW_OPTIONS_UI && isset( $_REQUEST['page'] ) && 'ot-settings' === $_REQUEST['page'] && $custom_options ) { // phpcs:ignore
			...
			function ot_has_custom_theme_options() {
				echo '<div class="error"><p>' . esc_html__( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'qc-opd' ) . '</p></div>';
			}
		...
		$ot_register_pages_array = array(
			array(
				'id'          => 'ot',
				'page_title'  => esc_html__( 'OptionTree', 'qc-opd' ),
				'menu_title'  => esc_html__( 'OptionTree', 'qc-opd' ),
			...
			array(
				...
				'page_title'      => esc_html__( 'Settings', 'qc-opd' ),
				'menu_title'      => esc_html__( 'Settings', 'qc-opd' ),
				'capability'      => 'edit_theme_options',
				'menu_slug'       => 'ot-settings',
				'icon_url'        => null,
				'position'        => null,
				'updated_message' => esc_html__( 'Theme Options updated.', 'qc-opd' ),
				'reset_message'   => esc_html__( 'Theme Options reset.', 'qc-opd' ),
				'button_text'     => esc_html__( 'Save Settings', 'qc-opd' ),
				'show_buttons'    => false,
				'sections'        => array(
					array(
						'id'    => 'create_setting',
						'title' => esc_html__( 'Theme Options UI', 'qc-opd' ),
					),
					array(
						'id'    => 'import',
						'title' => esc_html__( 'Import', 'qc-opd' ),
					),
					array(
						'id'    => 'export',
						'title' => esc_html__( 'Export', 'qc-opd' ),
					),
					array(
						'id'    => 'layouts',
						'title' => esc_html__( 'Layouts', 'qc-opd' ),
					),
				),
				'settings'        => array(
					array(
						'id'      => 'theme_options_ui_text',
						'label'   => esc_html__( 'Theme Options UI Builder', 'qc-opd' ),
						'type'    => 'theme_options_ui',
						'section' => 'create_setting',
					),
					array(
						'id'      => 'import_settings_text',
						'label'   => esc_html__( 'Settings', 'qc-opd' ),
						'type'    => 'import-settings',
						'section' => 'import',
					),
					array(
						'id'      => 'import_data_text',
						'label'   => esc_html__( 'Theme Options', 'qc-opd' ),
						'type'    => 'import-data',
						'section' => 'import',
					),
					array(
						'id'      => 'import_layouts_text',
						'label'   => esc_html__( 'Layouts', 'qc-opd' ),
						'type'    => 'import-layouts',
						'section' => 'import',
					),
					array(
						'id'      => 'export_settings_file_text',
						'label'   => esc_html__( 'Settings PHP File', 'qc-opd' ),
					...
					array(
						...
						'label'   => esc_html__( 'Layout Management', 'qc-opd' ),
						'type'    => 'modify-layouts',
						'section' => 'layouts',
					),
				),
			...
			array(
				'id'              => 'documentation',
				'parent_slug'     => 'ot-settings',
				'page_title'      => esc_html__( 'Documentation', 'qc-opd' ),
				'menu_title'      => esc_html__( 'Documentation', 'qc-opd' ),
				'capability'      => 'edit_theme_options',
				...
				'sections'        => array(
					array(
						'id'    => 'creating_options',
						'title' => esc_html__( 'Creating Options', 'qc-opd' ),
					),
					array(
						'id'    => 'option_types',
						'title' => esc_html__( 'Option Types', 'qc-opd' ),
					),
					array(
						'id'    => 'functions',
						'title' => esc_html__( 'Function References', 'qc-opd' ),
					),
					array(
						'id'    => 'theme_mode',
						'title' => esc_html__( 'Theme Mode', 'qc-opd' ),
					),
					array(
						'id'    => 'meta_boxes',
						'title' => esc_html__( 'Meta Boxes', 'qc-opd' ),
					),
					array(
						'id'    => 'examples',
						'title' => esc_html__( 'Code Examples', 'qc-opd' ),
					),
					array(
						'id'    => 'layouts_overview',
						'title' => esc_html__( 'Layouts Overview', 'qc-opd' ),
					),
				),
				'settings'        => array(
					array(
						'id'      => 'creating_options_text',
						'label'   => esc_html__( 'Overview of available Theme Option fields.', 'qc-opd' ),
						'type'    => 'creating-options',
						'section' => 'creating_options',
					),
					array(
						'id'      => 'option_types_text',
						'label'   => esc_html__( 'Option types in alphabetical order & hooks to filter them.', 'qc-opd' ),
						'type'    => 'option-types',
						'section' => 'option_types',
					),
					array(
						'id'      => 'functions_ot_get_option',
						'label'   => esc_html__( 'Function Reference:ot_get_option()', 'qc-opd' ),
						'type'    => 'ot-get-option',
						'section' => 'functions',
					),
					array(
						'id'      => 'functions_get_option_tree',
						'label'   => esc_html__( 'Function Reference:get_option_tree()', 'qc-opd' ),
						'type'    => 'get-option-tree',
						'section' => 'functions',
					),
					array(
						'id'      => 'theme_mode_text',
						'label'   => esc_html__( 'Theme Mode', 'qc-opd' ),
						'type'    => 'theme-mode',
						'section' => 'theme_mode',
					),
					array(
						'id'      => 'meta_boxes_text',
						'label'   => esc_html__( 'Meta Boxes', 'qc-opd' ),
						'type'    => 'meta-boxes',
						'section' => 'meta_boxes',
					),
					array(
						'id'      => 'example_text',
						'label'   => esc_html__( 'Code examples for front-end development.', 'qc-opd' ),
						'type'    => 'examples',
						'section' => 'examples',
					),
					array(
						'id'      => 'layouts_overview_text',
						'label'   => esc_html__( 'What\'s a layout anyhow?', 'qc-opd' ),
...
if ( ! function_exists( 'ot_after_theme_options_save' ) ) {
	...
	function ot_after_theme_options_save() {
		...
		$page    = isset( $_REQUEST['page'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_REQUEST['page'] ) ) ) : ''; // phpcs:ignore
...
if ( ! function_exists( 'ot_validate_setting' ) ) {
	...
	function ot_validate_setting( $input, $type, $field_id, $wmpl_id = '' ) {
		...
		$string_nums = esc_html__( 'The %1$s input field for %2$s only allows numeric values.', 'qc-opd' );
		...
		if ( 'background' === $type ) {
			...
			if ( is_string( $input ) ) {
				...
				$string_color = esc_html__( 'The %s Colorpicker only allows valid hexadecimal or rgba values depending on the setting type.', 'qc-opd' );
			...
			if ( ! empty( $input ) ) {
				if ( ! is_numeric( $input ) ) {
					add_settings_error( 'option-tree', 'invalid_numeric_slider', sprintf( $string_nums, '<code>' . esc_html__( 'slider', 'qc-opd' ) . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
				} else {
					$input_safe = sanitize_text_field( $input );
				}
			}
			...
			$string_error = esc_html__( 'Notice: %1$s was called incorrectly. All stored data must be filtered through %2$s, the %3$s option type is not using this filter. This is required since version %4$s.', 'qc-opd' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
	...
	function ot_admin_scripts() {
		...
		$localized_array = array(
			...
			'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'qc-opd' ) ),
			'remove_media_text'     => esc_html__( 'Remove Media', 'qc-opd' ),
			'reset_agree'           => esc_html__( 'Are you sure you want to reset back to the defaults?', 'qc-opd' ),
			'remove_no'             => esc_html__( 'You can\'t remove this! But you can edit the values.', 'qc-opd' ),
			'remove_agree'          => esc_html__( 'Are you sure you want to remove this?', 'qc-opd' ),
			'activate_layout_agree' => esc_html__( 'Are you sure you want to activate this layout?', 'qc-opd' ),
			'setting_limit'         => esc_html__( 'Sorry, you can\'t have settings three levels deep.', 'qc-opd' ),
			'delete'                => esc_html__( 'Delete Gallery', 'qc-opd' ),
			'edit'                  => esc_html__( 'Edit Gallery', 'qc-opd' ),
			'create'                => esc_html__( 'Create Gallery', 'qc-opd' ),
			'confirm'               => esc_html__( 'Are you sure you want to delete this Gallery?', 'qc-opd' ),
			'date_current'          => esc_html__( 'Today', 'qc-opd' ),
			'date_time_current'     => esc_html__( 'Now', 'qc-opd' ),
			'date_close'            => esc_html__( 'Close', 'qc-opd' ),
			'replace'               => esc_html__( 'Featured Image', 'qc-opd' ),
			'with'                  => esc_html__( 'Image', 'qc-opd' ),
		);
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
	...
	function ot_create_media_post() {
		...
		register_post_type(
			'option-tree',
			array(
				'labels'              => array( 'name' => esc_html__( 'Option Tree', 'qc-opd' ) ),
				'public'              => false,
				'show_ui'             => false,
		...
		if ( ! get_option( ot_settings_id() ) ) {
			...
			if ( $find_table === $table_name ) {
				...
				if ( false === $old_settings ) {
					$old_settings = $wpdb->get_results( $wpdb->prepare( "SELECT * FROM $table_name ORDER BY item_sort ASC" ) ); // phpcs:ignore
			...
			if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
				...
				$settings = array(
					'sections' => array(
						array(
							'id'    => 'general',
							'title' => esc_html__( 'General', 'qc-opd' ),
						),
					),
					'settings' => array(
						array(
							'id'        => 'sample_text',
							'label'     => esc_html__( 'Sample Text Field Label', 'qc-opd' ),
							'desc'      => esc_html__( 'Description for the sample text field.', 'qc-opd' ),
							'section'   => 'general',
							'type'      => 'text',
							'std'       => '',
							'class'     => '',
	...
	function ot_alert_message( $page = array() ) {
		...
		if ( 'save-settings' === $action ) {
			...
			if ( 'success' === $message ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings updated.', 'qc-opd' ) . '</p></div>';

			} elseif ( 'failed' === $message ) {

				return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be saved.', 'qc-opd' ) . '</p></div>';
			...
			if ( 'success' === $message ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings Imported.', 'qc-opd' ) . '</p></div>';

			} elseif ( 'failed' === $message ) {

				return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be imported.', 'qc-opd' ) . '</p></div>';
			...
			if ( 'success' === $message ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Data Imported.', 'qc-opd' ) . '</p></div>';

			} elseif ( 'failed' === $message ) {

				return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Data could not be imported.', 'qc-opd' ) . '</p></div>';
			...
			if ( 'success' === $message ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Imported.', 'qc-opd' ) . '</p></div>';

			} elseif ( 'failed' === $message ) {

				return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be imported.', 'qc-opd' ) . '</p></div>';
			...
			if ( 'success' === $message ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Updated.', 'qc-opd' ) . '</p></div>';

			} elseif ( 'failed' === $message ) {

				return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be updated.', 'qc-opd' ) . '</p></div>';

			} elseif ( 'deleted' === $message ) {

				return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts have been deleted.', 'qc-opd' ) . '</p></div>';

			}
		} elseif ( 'layout' === $updated ) {

			return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layout activated.', 'qc-opd' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
	...
	function ot_option_types_array() {
		...
		return apply_filters(
			...
			array(
				'background'                => esc_html__( 'Background', 'qc-opd' ),
				'border'                    => esc_html__( 'Border', 'qc-opd' ),
				'box-shadow'                => esc_html__( 'Box Shadow', 'qc-opd' ),
				'category-checkbox'         => esc_html__( 'Category Checkbox', 'qc-opd' ),
				'category-select'           => esc_html__( 'Category Select', 'qc-opd' ),
				'checkbox'                  => esc_html__( 'Checkbox', 'qc-opd' ),
				'colorpicker'               => esc_html__( 'Colorpicker', 'qc-opd' ),
				'colorpicker-opacity'       => esc_html__( 'Colorpicker Opacity', 'qc-opd' ),
				'css'                       => esc_html__( 'CSS', 'qc-opd' ),
				'custom-post-type-checkbox' => esc_html__( 'Custom Post Type Checkbox', 'qc-opd' ),
				'custom-post-type-select'   => esc_html__( 'Custom Post Type Select', 'qc-opd' ),
				'date-picker'               => esc_html__( 'Date Picker', 'qc-opd' ),
				'date-time-picker'          => esc_html__( 'Date Time Picker', 'qc-opd' ),
				'dimension'                 => esc_html__( 'Dimension', 'qc-opd' ),
				'gallery'                   => esc_html__( 'Gallery', 'qc-opd' ),
				'google-fonts'              => esc_html__( 'Google Fonts', 'qc-opd' ),
				'javascript'                => esc_html__( 'JavaScript', 'qc-opd' ),
				'link-color'                => esc_html__( 'Link Color', 'qc-opd' ),
				'list-item'                 => esc_html__( 'List Item', 'qc-opd' ),
				'measurement'               => esc_html__( 'Measurement', 'qc-opd' ),
				'numeric-slider'            => esc_html__( 'Numeric Slider', 'qc-opd' ),
				'on-off'                    => esc_html__( 'On/Off', 'qc-opd' ),
				'page-checkbox'             => esc_html__( 'Page Checkbox', 'qc-opd' ),
				'page-select'               => esc_html__( 'Page Select', 'qc-opd' ),
				'post-checkbox'             => esc_html__( 'Post Checkbox', 'qc-opd' ),
				'post-select'               => esc_html__( 'Post Select', 'qc-opd' ),
				'radio'                     => esc_html__( 'Radio', 'qc-opd' ),
				'radio-image'               => esc_html__( 'Radio Image', 'qc-opd' ),
				'select'                    => esc_html__( 'Select', 'qc-opd' ),
				'sidebar-select'            => esc_html__( 'Sidebar Select', 'qc-opd' ),
				'slider'                    => esc_html__( 'Slider', 'qc-opd' ),
				'social-links'              => esc_html__( 'Social Links', 'qc-opd' ),
				'spacing'                   => esc_html__( 'Spacing', 'qc-opd' ),
				'tab'                       => esc_html__( 'Tab', 'qc-opd' ),
				'tag-checkbox'              => esc_html__( 'Tag Checkbox', 'qc-opd' ),
				'tag-select'                => esc_html__( 'Tag Select', 'qc-opd' ),
				'taxonomy-checkbox'         => esc_html__( 'Taxonomy Checkbox', 'qc-opd' ),
				'taxonomy-select'           => esc_html__( 'Taxonomy Select', 'qc-opd' ),
				'text'                      => esc_html__( 'Text', 'qc-opd' ),
				'textarea'                  => esc_html__( 'Textarea', 'qc-opd' ),
				'textarea-simple'           => esc_html__( 'Textarea Simple', 'qc-opd' ),
				'textblock'                 => esc_html__( 'Textblock', 'qc-opd' ),
				'textblock-titled'          => esc_html__( 'Textblock Titled', 'qc-opd' ),
				'typography'                => esc_html__( 'Typography', 'qc-opd' ),
				'upload'                    => esc_html__( 'Upload', 'qc-opd' ),
			)
		);
	}
}
	...
	function ot_radio_images( $field_id ) {
		...
		return apply_filters(
			...
			array(
				array(
					'value' => 'left-sidebar',
					'label' => esc_html__( 'Left Sidebar', 'qc-opd' ),
					'src'   => OT_URL . 'assets/images/layout/left-sidebar.png',
				),
				array(
					'value' => 'right-sidebar',
					'label' => esc_html__( 'Right Sidebar', 'qc-opd' ),
					'src'   => OT_URL . 'assets/images/layout/right-sidebar.png',
				),
				array(
					'value' => 'full-width',
					'label' => esc_html__( 'Full Width (no sidebar)', 'qc-opd' ),
					'src'   => OT_URL . 'assets/images/layout/full-width.png',
				),
				array(
					'value' => 'dual-sidebar',
					'label' => esc_html__( 'Dual Sidebar', 'qc-opd' ),
					'src'   => OT_URL . 'assets/images/layout/dual-sidebar.png',
				),
				array(
					'value' => 'left-dual-sidebar',
					'label' => esc_html__( 'Left Dual Sidebar', 'qc-opd' ),
					'src'   => OT_URL . 'assets/images/layout/left-dual-sidebar.png',
				),
				array(
					'value' => 'right-dual-sidebar',
					'label' => esc_html__( 'Right Dual Sidebar', 'qc-opd' ),
	...
	function ot_list_item_settings( $field_id ) {
		...
		$settings = apply_filters(
			...
			array(
				...
				array(
					'id'        => 'description',
					'label'     => esc_html__( 'Description', 'qc-opd' ),
					'desc'      => '',
					'std'       => '',
...
if ( ! function_exists( 'ot_social_links_settings' ) ) {
	...
	function ot_social_links_settings( $field_id ) {
		...
		$string   = esc_html__( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'qc-opd' );
		$settings = apply_filters(
			'ot_social_links_settings',
			array(
				array(
					'id'    => 'name',
					'label' => esc_html__( 'Name', 'qc-opd' ),
					'desc'  => esc_html__( 'Enter the name of the social website.', 'qc-opd' ),
					'std'   => '',
					'type'  => 'text',
				...
				array(
					'id'    => 'title',
					'label' => 'Title',
					'desc'  => esc_html__( 'Enter the text shown in the title attribute of the link.', 'qc-opd' ),
					'type'  => 'text',
				),
				array(
					'id'    => 'href',
	...
	function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
		...
		if ( is_writeable( $filepath ) && 'css' === $file_ext ) {
			...
			if ( ! is_writable( $filepath ) ) {
				...
				$string = esc_html__( 'Unable to write to file %s.', 'qc-opd' );
			...
			if ( ! $f ) {
				/* translators: %s: file path */
				$string = esc_html__( 'Unable to open the %s file in write mode.', 'qc-opd' );
				add_settings_error( 'option-tree', 'dynamic_css', sprintf( $string, '<code>' . $filepath . '</code>' ), 'error' );
				return false;
			}
...
if ( ! function_exists( 'ot_sections_view' ) ) {
	...
	function ot_sections_view( $name, $key, $section = array() ) {
		...
		$str_title = esc_html__( '%s: Displayed as a menu item on the Theme Options page.', 'qc-opd' );

		/* translators: %s: Section ID emphasized */
		$str_id = esc_html__( '%s: A unique lower case alphanumeric string, underscores allowed.', 'qc-opd' );
		...
		<div class="option-tree-setting is-section">
			...
			<div class="button-section">
				<a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . esc_html__( 'edit', 'qc-opd' ) . '">
					<span class="icon ot-icon-pencil"></span>' . esc_html__( 'Edit', 'qc-opd' ) . '
				</a>
				<a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'qc-opd' ) . '">
					<span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'qc-opd' ) . '
				</a>
			</div>
			<div class="option-tree-setting-body">
				<div class="format-settings">
					<div class="format-setting type-text">
						<div class="description">' . sprintf( $str_title, '<strong>' . esc_html__( 'Section Title', 'qc-opd' ) . '</strong>', 'qc-opd' ) . '</div>
				...
				<div class="format-settings">
					<div class="format-setting type-text">
						<div class="description">' . sprintf( $str_id, '<strong>' . esc_html__( 'Section ID', 'qc-opd' ) . '</strong>', 'qc-opd' ) . '</div>
						<div class="format-setting-inner">
...
if ( ! function_exists( 'ot_settings_view' ) ) {
	...
	function ot_settings_view( $name, $key, $setting = array() ) {
		...
		$str_label = esc_html__( '%s: Displayed as the label of a form element on the Theme Options page.', 'qc-opd' );

		/* translators: %s: ID emphasized */
		$str_id = esc_html__( '%s: A unique lower case alphanumeric string, underscores allowed.', 'qc-opd' );

		/* translators: %s: Type emphasized */
		$str_type = esc_html__( '%s: Choose one of the available option types from the dropdown.', 'qc-opd' );

		/* translators: %s: Description emphasized */
		$str_desc = esc_html__( '%s: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'qc-opd' );

		/* translators: %s: Choices emphasized */
		$str_choices = esc_html__( '%s: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'qc-opd' );

		/* translators: %s: Settings emphasized */
		$str_settings = esc_html__( '%s: This will only affect the List Item option type.', 'qc-opd' );

		/* translators: %1$s: Standard emphasized, %2$s: visual path to documentation */
		$str_standard = esc_html__( '%1$s: Setting the standard value for your option only works for some option types. Read the %2$s for more information on which ones.', 'qc-opd' );

		/* translators: %s: Rows emphasized */
		$str_rows = esc_html__( '%s: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'qc-opd' );

		/* translators: %s: Post Type emphasized */
		$str_post_type = esc_html__( '%s: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'qc-opd' );

		/* translators: %s: Taxonomy emphasized */
		$str_taxonomy = esc_html__( '%s: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'qc-opd' );

		/* translators: %1$s: Min, Max, & Step emphasized, %2$s: format, %3$s: range, %4$s: minimum interval */
		$str_min_max_step = esc_html__( '%1$s: Add a comma separated list of options in the following format %2$s (slide from %3$s in intervals of %4$s). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'qc-opd' );

		/* translators: %s: CSS Class emphasized */
		$str_css_class = esc_html__( '%s: Add and optional class to this option type.', 'qc-opd' );

		/* translators: %1$s: Condition emphasized, %2$s: example value, %3$s: list of valid conditions */
		$str_condition = esc_html__( '%1$s: Add a comma separated list (no spaces) of conditions in which the field will be visible, leave this setting empty to always show the field. In these examples, %2$s is a placeholder for your condition, which can be in the form of %3$s.', 'qc-opd' );

		/* translators: %s: Operator emphasized */
		$str_operator = esc_html__( '%s: Choose the logical operator to compute the result of the conditions.', 'qc-opd' );
			...
			<div class="option-tree-setting-body">
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_label, '<strong>' . esc_html__( 'Label', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_id, '<strong>' . esc_html__( 'ID', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-select wide-desc">
						<div class="description">' . sprintf( $str_type, '<strong>' . esc_html__( 'Type', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-textarea wide-desc">
						<div class="description">' . sprintf( $str_desc, '<strong>' . esc_html__( 'Description', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-textblock wide-desc">
						<div class="description">' . sprintf( $str_choices, '<strong>' . esc_html__( 'Choices', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
							...
							<a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Choice', 'qc-opd' ) . '</a>
						</div>
					</div>
				</div>
				<div class="format-settings">
					<div class="format-setting type-textblock wide-desc">
						<div class="description">' . sprintf( $str_settings, '<strong>' . esc_html__( 'Settings', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
							<ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
								' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
							</ul>
							<a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Setting', 'qc-opd' ) . '</a>
						</div>
					</div>
				</div>
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_standard, '<strong>' . esc_html__( 'Standard', 'qc-opd' ) . '</strong>', '<code>' . esc_html__( 'OptionTree->Documentation', 'qc-opd' ) . '</code>' ) . '</div>
						<div class="format-setting-inner">
							' . $std_form_element . '
						</div>
					</div>
				...
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_rows, '<strong>' . esc_html__( 'Rows', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_post_type, '<strong>' . esc_html__( 'Post Type', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_taxonomy, '<strong>' . esc_html__( 'Taxonomy', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_min_max_step, '<strong>' . esc_html__( 'Min, Max, & Step', 'qc-opd' ) . '</strong>', '<code>0,100,1</code>', '<code>0-100</code>', '<code>1</code>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-text wide-desc">
						<div class="description">' . sprintf( $str_css_class, '<strong>' . esc_html__( 'CSS Class', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-select wide-desc">
						<div class="description">' . sprintf( $str_operator, '<strong>' . esc_html__( 'Operator', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
							<select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . esc_attr( $operator ) . '" class="option-tree-ui-select">
								<option value="and" ' . selected( $operator, 'and', false ) . '>' . esc_html__( 'and', 'qc-opd' ) . '</option>
								<option value="or" ' . selected( $operator, 'or', false ) . '>' . esc_html__( 'or', 'qc-opd' ) . '</option>
							</select>
						</div>
					</div>
				</div>
	...
	function ot_choices_view( $name, $key, $choice = array() ) {
		...
		<div class="option-tree-setting">
			...
			<div class="option-tree-setting-body">
				...
				<div class="format-settings">
					<div class="format-setting-label">
						<h5>' . esc_html__( 'Image Source (Radio Image only)', 'qc-opd' ) . '</h5>
					</div>
					<div class="format-setting type-text wide-desc">
						<div class="format-setting-inner">
...
if ( ! function_exists( 'ot_contextual_help_view' ) ) {
	...
	function ot_contextual_help_view( $name, $key, $content = array() ) {
		...
		$str_title = esc_html__( '%s: Displayed as a contextual help menu item on the Theme Options page.', 'qc-opd' );

		/* translators: %s: ID emphasized */
		$str_id = esc_html__( '%s: A unique lower case alphanumeric string, underscores allowed.', 'qc-opd' );

		/* translators: %s: Content emphasized */
		$str_content = esc_html__( '%s: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'qc-opd' );
			...
			<div class="option-tree-setting-body">
				<div class="format-settings">
					<div class="format-setting type-text no-desc">
						<div class="description">' . sprintf( $str_title, '<strong>' . esc_html__( 'Title', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
				...
				<div class="format-settings">
					<div class="format-setting type-textarea no-desc">
						<div class="description">' . sprintf( $str_content, '<strong>' . esc_html__( 'Content', 'qc-opd' ) . '</strong>' ) . '</div>
						<div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
	...
	function ot_layout_view( $key, $data = '', $active_layout = '' ) {
		...
		return '
		<div class="option-tree-setting">
			<div class="open">' . ( isset( $key ) ? esc_attr( $key ) : esc_html__( 'Layout', 'qc-opd' ) ) . '</div>
			<div class="button-section">
				<a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout === $key ? ' active' : '' ) . '" title="' . esc_html__( 'Activate', 'qc-opd' ) . '">
					<span class="icon ot-icon-square-o"></span>' . esc_html__( 'Activate', 'qc-opd' ) . '
				</a>
				<a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'qc-opd' ) . '">
					<span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'qc-opd' ) . '
				</a>
...
if ( ! function_exists( 'ot_theme_options_layouts_form' ) ) {
	...
	function ot_theme_options_layouts_form() {
		...
		echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . esc_html__( 'New Layout', 'qc-opd' ) . '">' . esc_html__( 'New Layout', 'qc-opd' ) . '</button>';
	...
	function ot_meta_box_post_format_gallery( $pages = 'post' ) {
		...
		return apply_filters(
			...
			array(
				...
				'title'    => esc_html__( 'Gallery', 'qc-opd' ),
				'desc'     => '',
				'pages'    => $pages,
				'context'  => 'side',
				'priority' => 'low',
			...
			array(
				...
				'fields'   => array(
					array(
						'id'    => '_format_link_url',
						'label' => '',
						'desc'  => esc_html__( 'Link URL', 'qc-opd' ),
						'std'   => '',
						'type'  => 'text',
					),
					array(
						...
						'label' => '',
						'desc'  => esc_html__( 'Link Title', 'qc-opd' ),
						'std'   => '',
						'type'  => 'text',
					),
				),
			...
			array(
				...
				'fields'   => array(
					array(
						...
						'label' => '',
						'desc'  => esc_html__( 'Source Name (ex. author, singer, actor)', 'qc-opd' ),
						'std'   => '',
						'type'  => 'text',
					),
					array(
						...
						'label' => '',
						'desc'  => esc_html__( 'Source URL', 'qc-opd' ),
						'std'   => '',
						'type'  => 'text',
					),
					array(
						...
						'label' => '',
						'desc'  => esc_html__( 'Source Title (ex. book, song, movie)', 'qc-opd' ),
						'std'   => '',
						'type'  => 'text',
					),
					array(
						...
						'label' => '',
						'desc'  => esc_html__( 'Source Date', 'qc-opd' ),
						'std'   => '',
						'type'  => 'text',
					),
				),
...
if ( ! function_exists( 'ot_meta_box_post_format_video' ) ) {
	...
	function ot_meta_box_post_format_video( $pages = 'post' ) {
		...
		$string = esc_html__( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'qc-opd' );

		return apply_filters(
			'ot_meta_box_post_format_video',
			array(
				'id'       => 'ot-post-format-video',
				'title'    => __( 'Video', 'qc-opd' ),
				'desc'     => '',
				'pages'    => $pages,
				'context'  => 'side',
				'priority' => 'low',
				'fields'   => array(
					array(
						...
						'label' => '',
						'desc'  => sprintf( $string, '<a href="https://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'WordPress Codex', 'qc-opd' ) . '</a>', '<code>[video]</code>' ),
						'std'   => '',
						'type'  => 'textarea',
					),
				),
...
if ( ! function_exists( 'ot_meta_box_post_format_audio' ) ) {
	...
	function ot_meta_box_post_format_audio( $pages = 'post' ) {
		...
		$string = esc_html__( 'Embed audio from services like SoundCloud and Radio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'qc-opd' );

		return apply_filters(
			'ot_meta_box_post_format_audio',
			array(
				'id'       => 'ot-post-format-audio',
				'title'    => esc_html__( 'Audio', 'qc-opd' ),
				'desc'     => '',
				'pages'    => $pages,
				'context'  => 'side',
				'priority' => 'low',
				'fields'   => array(
					array(
						...
						'label' => '',
						'desc'  => sprintf( $string, '<a href="https://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'WordPress Codex', 'qc-opd' ) . '</a>', '<code>[audio]</code>' ),
						'std'   => '',
						'type'  => 'textarea',
					),
				),
