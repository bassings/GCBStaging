...
if ( ! function_exists( 'ot_display_by_type' ) ) {
	...
	function ot_display_by_type( $args = array() ) {
		...
		if ( function_exists( $function_name_by_type ) ) {
			...
			echo '<p>' . esc_html__( 'Sorry, this function does not exist', 'qc-opd' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_background' ) ) {
	...
	function ot_type_background( $args = array() ) {
		...
		if ( in_array( 'background-repeat', $ot_recognized_background_fields, true ) ) {
			...
			echo '<option value="">' . esc_html__( 'background-repeat', 'qc-opd' ) . '</option>';
		...
		if ( in_array( 'background-attachment', $ot_recognized_background_fields, true ) ) {
			...
			echo '<option value="">' . esc_html__( 'background-attachment', 'qc-opd' ) . '</option>';
		...
		if ( in_array( 'background-position', $ot_recognized_background_fields, true ) ) {
			...
			echo '<option value="">' . esc_html__( 'background-position', 'qc-opd' ) . '</option>';
		...
		if ( in_array( 'background-size', $ot_recognized_background_fields, true ) ) {
			...
			if ( is_array( $choices ) && ! empty( $choices ) ) {
				...
				echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . esc_attr( isset( $field_value['background-size'] ) ? $field_value['background-size'] : '' ) . '" class="widefat ot-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'background-size', 'qc-opd' ) . '" />';
			}
		}
		...
		if ( in_array( 'background-image', $ot_recognized_background_fields, true ) ) {
			...
			// Input.
			echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-image]" id="' . esc_attr( $field_id ) . '" value="' . esc_attr( isset( $field_value['background-image'] ) ? $field_value['background-image'] : '' ) . '" class="widefat option-tree-ui-upload-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'background-image', 'qc-opd' ) . '" />';

			// Add media button.
			echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . esc_attr( $post_id ) . '" title="' . esc_html__( 'Add Media', 'qc-opd' ) . '"><span class="icon ot-icon-plus-circle"></span>' . esc_html__( 'Add Media', 'qc-opd' ) . '</a>';
			...
			if ( isset( $field_value['background-image'] ) && '' !== $field_value['background-image'] ) {
				...
				echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . esc_html__( 'Remove Media', 'qc-opd' ) . '"><span class="icon ot-icon-minus-circle"></span>' . esc_html__( 'Remove Media', 'qc-opd' ) . '</a>';
...
if ( ! function_exists( 'ot_type_border' ) ) {
	...
	function ot_type_border( $args = array() ) {
		...
		if ( in_array( 'width', $ot_recognized_border_fields, true ) ) {
			...
			echo '<div class="ot-option-group ot-option-group--one-sixth"><input type="text" name="' . esc_attr( $field_name ) . '[width]" id="' . esc_attr( $field_id ) . '-width" value="' . esc_attr( $width ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'width', 'qc-opd' ) . '" /></div>';
		}
		...
		if ( in_array( 'unit', $ot_recognized_border_fields, true ) ) {
			...
			echo '<option value="">' . esc_html__( 'unit', 'qc-opd' ) . '</option>';
		...
		if ( in_array( 'style', $ot_recognized_border_fields, true ) ) {
			...
			echo '<option value="">' . esc_html__( 'style', 'qc-opd' ) . '</option>';
...
if ( ! function_exists( 'ot_type_category_checkbox' ) ) {
	...
	function ot_type_category_checkbox( $args = array() ) {
		...
		if ( ! empty( $categories ) ) {
			...
			echo '<p>' . esc_html__( 'No Categories Found', 'qc-opd' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_custom_post_type_checkbox' ) ) {
	...
	function ot_type_custom_post_type_checkbox( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<p>' . esc_html__( 'No Posts Found', 'qc-opd' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_custom_post_type_select' ) ) {
	...
	function ot_type_custom_post_type_select( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<option value="">' . esc_html__( 'No Posts Found', 'qc-opd' ) . '</option>';
		}
	...
	function ot_type_gallery( $args = array() ) {
		...
		if ( ! empty( $ids ) ) {
			...
			<div class="ot-gallery-buttons">
				<a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . esc_html__( 'Delete Gallery', 'qc-opd' ) . '</a>
				<a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Edit Gallery', 'qc-opd' ) . '</a>
			</div>';
			...
			echo '
			<div class="ot-gallery-buttons">
				<a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Create Gallery', 'qc-opd' ) . '</a>
			</div>';
...
if ( ! function_exists( 'ot_type_google_fonts' ) ) {
	...
	function ot_type_google_fonts( $args = array() ) {
		...
		foreach ( $field_value as $key => $value ) {
			...
			echo '<a href="javascript:void(0);" class="js-remove-google-font option-tree-ui-button button button-secondary light" title="' . esc_html__( 'Remove Google Font', 'qc-opd' ) . '"><span class="icon ot-icon-minus-circle"/>' . esc_html__( 'Remove Google Font', 'qc-opd' ) . '</a>';
		...
		echo '<a href="javascript:void(0);" class="js-add-google-font option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add Google Font', 'qc-opd' ) . '">' . esc_html__( 'Add Google Font', 'qc-opd' ) . '</a>';
...
if ( ! function_exists( 'ot_type_link_color' ) ) {
	...
	function ot_type_link_color( $args = array() ) {
		...
		$ot_recognized_link_color_fields = apply_filters(
			...
			array(
				'link'    => _x( 'Standard', 'color picker', 'qc-opd' ),
				'hover'   => _x( 'Hover', 'color picker', 'qc-opd' ),
				'active'  => _x( 'Active', 'color picker', 'qc-opd' ),
				'visited' => _x( 'Visited', 'color picker', 'qc-opd' ),
				'focus'   => _x( 'Focus', 'color picker', 'qc-opd' ),
			),
			$field_id
		);
...
if ( ! function_exists( 'ot_type_list_item' ) ) {
	...
	function ot_type_list_item( $args = array() ) {
		...
		// Button.
		echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'qc-opd' ) . '">' . esc_html__( 'Add New', 'qc-opd' ) . '</a>';

		// Description.
		$list_desc = $sortable ? __( 'You can re-order with drag & drop, the order will update after saving.', 'qc-opd' ) : '';
	...
	function ot_type_on_off( $args = array() ) {
		...
		$field_choices = array(
			array(
				 ...
				 */
				'label' => apply_filters( 'ot_on_off_switch_on_label', esc_html__( 'On', 'qc-opd' ), $field_id, 'on' ),
			),
			array(
				/**
				 ...
				 * @param string $filter_id For filtering both on/off label with one function.
				 */
				'label' => apply_filters( 'ot_on_off_switch_off_label', esc_html__( 'Off', 'qc-opd' ), $field_id, 'off' ),
			),
		);
...
if ( ! function_exists( 'ot_type_page_checkbox' ) ) {
	...
	function ot_type_page_checkbox( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<p>' . esc_html__( 'No Pages Found', 'qc-opd' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_page_select' ) ) {
	...
	function ot_type_page_select( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<option value="">' . esc_html__( 'No Pages Found', 'qc-opd' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_sidebar_select' ) ) {
	...
	function ot_type_sidebar_select( $args = array() ) {
		...
		// Has sidebars.
		if ( count( $sidebars ) ) {
			echo '<option value="">-- ' . esc_html__( 'Choose Sidebar', 'qc-opd' ) . ' --</option>';
			foreach ( $sidebars as $id => $sidebar ) {
				echo '<option value="' . esc_attr( $id ) . '" ' . selected( $field_value, $id, false ) . '>' . esc_attr( $sidebar ) . '</option>';
			}
		} else {
			echo '<option value="">' . esc_html__( 'No Sidebars', 'qc-opd' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_slider' ) ) {
	...
	function ot_type_slider( $args = array() ) {
		...
		// Button.
		echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'qc-opd' ) . '">' . esc_html__( 'Add New', 'qc-opd' ) . '</a>'; // phpcs:ignore

		// Description.
		echo '<div class="list-item-description">' . esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'qc-opd' ) . '</div>';
	...
	function ot_type_social_links( $args = array() ) {
		...
		if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
			...
			$field_value = apply_filters(
				...
				array(
					array(
						'name'  => __( 'Facebook', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Twitter', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Google+', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'LinkedIn', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Pinterest', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Youtube', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Dribbble', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Github', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Forrst', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
					...
					array(
						'name'  => __( 'Delicious', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Tumblr', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Skype', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'SoundCloud', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Vimeo', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'Flickr', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
					array(
						'name'  => __( 'VK.com', 'qc-opd' ),
						'title' => '',
						'href'  => '',
					),
				),
		...
		// Button.
		echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'qc-opd' ) . '">' . esc_html__( 'Add New', 'qc-opd' ) . '</a>'; // phpcs:ignore

		// Description.
		echo '<div class="list-item-description">' . esc_html( apply_filters( 'ot_social_links_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'qc-opd' ), $field_id ) ) . '</div>';
...
if ( ! function_exists( 'ot_type_spacing' ) ) {
	...
	function ot_type_spacing( $args = array() ) {
		...
		if ( in_array( 'top', $ot_recognized_spacing_fields, true ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-up ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[top]" id="' . esc_attr( $field_id ) . '-top" value="' . esc_attr( $top ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'top', 'qc-opd' ) . '" /></div>';
		}
		...
		if ( in_array( 'right', $ot_recognized_spacing_fields, true ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-right ot-option-group--icon"></span></span><input type="text" name="' . esc_attr( $field_name ) . '[right]" id="' . esc_attr( $field_id ) . '-right" value="' . esc_attr( $right ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'right', 'qc-opd' ) . '" /></div>';
		}
		...
		if ( in_array( 'bottom', $ot_recognized_spacing_fields, true ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-down ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[bottom]" id="' . esc_attr( $field_id ) . '-bottom" value="' . esc_attr( $bottom ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'bottom', 'qc-opd' ) . '" /></div>';
		}
		...
		if ( in_array( 'left', $ot_recognized_spacing_fields, true ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-left ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[left]" id="' . esc_attr( $field_id ) . '-left" value="' . esc_attr( $left ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'left', 'qc-opd' ) . '" /></div>';
		}
...
if ( ! function_exists( 'ot_type_tag_checkbox' ) ) {
	...
	function ot_type_tag_checkbox( $args = array() ) {
		...
		if ( $tags ) {
			...
			echo '<p>' . esc_html__( 'No Tags Found', 'qc-opd' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_tag_select' ) ) {
	...
	function ot_type_tag_select( $args = array() ) {
		...
		if ( $tags ) {
			...
			echo '<option value="">' . esc_html__( 'No Tags Found', 'qc-opd' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_taxonomy_checkbox' ) ) {
	...
	function ot_type_taxonomy_checkbox( $args = array() ) {
		...
		if ( $taxonomies ) {
			...
			echo '<p>' . esc_html__( 'No Taxonomies Found', 'qc-opd' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_taxonomy_select' ) ) {
	...
	function ot_type_taxonomy_select( $args = array() ) {
		...
		if ( $taxonomies ) {
			...
			echo '<option value="">' . esc_html__( 'No Taxonomies Found', 'qc-opd' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_upload' ) ) {
	...
	function ot_type_upload( $args = array() ) {
		...
		// Add media button.
		echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . esc_attr( $post_id ) . '" title="' . esc_html__( 'Add Media', 'qc-opd' ) . '"><span class="icon ot-icon-plus-circle"></span>' . esc_html__( 'Add Media', 'qc-opd' ) . '</a>'; // phpcs:ignore
