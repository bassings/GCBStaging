<?php wp_enqueue_style('sld-css-style-2', SLD_OCOPD_TPL_URL . "/$template_code/template.css" ); ?>
...
if ( $list_query->have_posts() )
{
	...
	echo '<div class="qcld-main-container-style-2"><div class="qcopd-list-wrapper qc-full-wrapper '. $subtitle_present_class . '">';
	?>
	<?php
	//if(sld_get_option('sld_enable_filtering_left')=='on' || $enable_left_filter=='true') {
    if( ( sld_get_option('sld_enable_filtering_left')=='on' && $enable_left_filter !='false'  ) || $enable_left_filter=='true') {
...
<?php
	...
	if(is_user_logged_in() and $sldfavorite=='on'){
        ...
        $bookmark_list_custom_css .= "#bookmark_list.style-2 .ca-menu li {
			...
			#bookmark_list.style-2 .ca-menu li .ca-main {
			  color: ".$conf['list_txt_color'].";";
				...
				if( isset($conf['item_title_font_size']) && $conf['item_title_line_height']!=''):
			...
			#bookmark_list.style-2 .ca-menu li .ca-sub {
			  color: ".$conf['list_subtxt_color'].";";
				if( isset($conf['item_title_font_size']) && $conf['item_subtitle_font_size']!=''):
				$bookmark_list_custom_css .= "font-size: ".$conf['item_subtitle_font_size']." !important;";
				endif;

				if( isset($conf['item_title_font_size']) && $conf['item_subtitle_line_height']!=''):
			...
			#bookmark_list.style-2 .ca-menu li .upvote-section .upvote-btn, #qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li .upvote-section .upvote-count{
			  color: ".$conf['list_subtxt_color'].";
			}
        ...
        wp_add_inline_style( 'sld-css-style-2', $bookmark_list_custom_css );
...
//adding extra variable in config
		...
		$qcopd_list_custom_css .= "#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li {
			    background-color: ".$conf['list_bg_color'].";
				box-shadow: 1px 1px 2px ".$conf['item_bdr_color'].";
			}

			#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li:hover {
			    background-color: ".$conf['list_bg_color_hov'].";
				color: ".$conf['list_txt_color_hov'].";
				box-shadow: 1px 1px 2px ".$conf['item_bdr_color_hov'].";
			}

			#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li .ca-main {
			  color: ".$conf['list_txt_color'].";";
			...
			#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li:hover .ca-main {
			  color: ".$conf['list_txt_color_hov'].";
			}

			#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li .ca-sub {
			  color: ".$conf['list_subtxt_color'].";";
			...
			#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li:hover .ca-sub {
			  color: ".$conf['list_subtxt_color_hov'].";
			}

			#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li .upvote-section .upvote-btn, #qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li .upvote-section .upvote-count{
			  color: ".$conf['list_subtxt_color'].";
			}

			#qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li:hover .upvote-section .upvote-btn, #qcopd-list-".$listId .'-'. get_the_ID().".style-2 .ca-menu li:hover .upvote-section .upvote-count{
			  color: ".$conf['list_subtxt_color_hov'].";
			}
			...
			$qcopd_list_custom_css .= ".qcopd-list-wrapper .style-2 .featured-section {
        ...
        wp_add_inline_style( 'sld-css-style-2', $qcopd_list_custom_css );
						...
						<?php } ?>
							...
							<?php if( $upvote == 'on' ) : ?>
								...
								<div class="upvote-section upvote-section-style-2">
									<span data-post-id="<?php echo esc_attr(get_the_ID()); ?>" data-unique="<?php echo get_the_ID().'_'.($list['qcopd_timelaps']!=''?$list['qcopd_timelaps']:$count); ?>" data-item-title="<?php echo esc_html(trim($list['qcopd_item_title'])); ?>" data-item-link="<?php echo esc_url($list['qcopd_item_link']); ?>" class="upvote-btn upvote-on">
