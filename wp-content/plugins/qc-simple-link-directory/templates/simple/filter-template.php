...
if( $filterType == 'normal' ) :
    ...
    <div class="filter-area <?php if( $MobilefilterType == 'on' ){ echo 'sld-mobile-list-filter-enable'; } ?>">
		...
		<?php foreach ($listItems as $item) :
            ...
            <a href="#" class="filter-btn" title="<?php echo esc_attr($item->post_title); ?>" data-filter="opd-list-id-<?php echo $item->ID; ?>" style="background:<?php echo $filter_background_color ?>;color:<?php echo $filter_text_color ?> !important;">
				<?php echo esc_html($item->post_title); ?>
				<?php
				if($item_count == 'on'){
...
if( $filterType == 'carousel' ) :
    ...
    <div class="filter-area-main">
        <div class="filter-area <?php if( $MobilefilterType == 'on' ){ echo 'sld-mobile-list-filter-enable'; } ?>" style="width: 100%;">
