...
class Smartcrawl_Onpage_Settings extends Smartcrawl_Settings_Admin {
	...
	private static function sitemap_notice( $type ) {
		...
		ob_start();
		?>
		<div class="wds-notice sui-notice sui-notice-info <?php echo $indexed ? 'hidden' : ''; ?>">
	...
	public function json_save_static_homepage_meta() {
		...
		$description = smartcrawl_get_array_value( $request_data, array( 'wds_onpage_options', 'metadesc-static-home' ) );
		if ( $description ) {
