...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<div class="sui-side-tabs sui-tabs">
			<div data-tabs>
				<label class="<?php echo $keep_settings ? 'active' : ''; ?>">
		...
		<div class="sui-side-tabs sui-tabs">
			<div data-tabs>
				<label class="<?php echo $keep_data ? 'active' : ''; ?>">
...
<?php if ( $show_subsite_controls ): ?>
	<div class="sui-box-settings-row">
		...
		<div class="sui-box-settings-col-2">
			...
			<button type="button"
			        data-a11y-dialog-show="wds-multisite-data-reset-modal"
...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		<button type="button"
		        data-a11y-dialog-show="wds-data-reset-modal"
