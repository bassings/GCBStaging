...
Please email to <span style="color:#22A0C9;font-weight:bold !important;font-size:14px "> quantumcloud@gmail.com </span> with any feedback. We will get back to you right away!', 'qc-opd');
		...
		{
			$data['message'] = __('Please fill up all the requried form fields.', 'qc-opd');
		}
		else if ( filter_var($email, FILTER_VALIDATE_EMAIL) === false ) 
		{
			$data['message'] = __('Invalid email address.', 'qc-opd');
		}
		else
		{
			...
			$finalSubject = esc_html( 'From Plugin Support Page:', 'qc-opd' )." " . $subject;
			...
			{
				$data['status'] = 'success';
				$data['message'] = __('Your email was sent successfully. Thanks!', 'qc-opd');
			}
            ...
            <div class="support-btn-main clearfix-div">
                ...
                <div class="qc-column-12">
                    ...
                    <div class="support-btn">
                        <a class="premium-support" href="https://qc.turbopowers.com/" target="_blank">GET PRIORITY SUPPORT</a>
...
if( is_admin() )
{
	...
	$instance_qcsldpremium12->promo_menu_title = __("Support"); //Edit Value
