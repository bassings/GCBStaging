...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		$this->_render( 'toggle-item', array(
			...
			'checked'    => ( ! empty( $_view['options']['analysis-seo'] ) ) ? "checked='checked' " : '',
		...
		$this->_render( 'toggle-item', array(
			...
			'checked'    => ( ! empty( $_view['options']['analysis-readability'] ) ) ? "checked='checked' " : '',
		...
		<div class="wds-analysis-strategy-tabs sui-side-tabs sui-tabs">
			<div data-tabs>
				<label class="wds-strategy-strict <?php echo $is_strategy_strict ? 'active' : ''; ?>">
				...
				<label class="wds-strategy-moderate <?php echo $is_strategy_moderate ? 'active' : ''; ?>">
				...
				<label class="wds-strategy-loose <?php echo $is_strategy_loose ? 'active' : ''; ?>">
				...
				<label class="wds-strategy-manual <?php echo $is_strategy_manual ? 'active' : ''; ?>">
