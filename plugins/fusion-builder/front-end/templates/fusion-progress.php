...
const value                   = 'percentage' === values.value_display_type ? percentage : values.percentage;
const valueWrap               = 'yes' === values.show_percentage ? ' <span ' + _.fusionGetAttributes( 'fusion-progressbar-value' ) + '>' + value + values.unit + '</span>' : '';
...
const maximumValue            = 'percentage' === values.value_display_type ? '100' : values.maximum_value;
const maximumValueWrap        = 'yes' === values.display_maximum_value ? ' <span class="awb-pb-max-value">' + maximumValue + values.maximum_value_unit + '</span>' : '';
